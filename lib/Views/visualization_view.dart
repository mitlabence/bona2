        ...
        body: Center(
          child: testAsyncValue.when(
            data: (dataPoints) {
              ...
              final TimeSeriesData timeSeriesData = TimeSeriesData(ts, ys, yUnit: "EUR")
                  .resampleMonths(
              ...
              return SfCartesianChart(
                ...
                tooltipBehavior: TooltipBehavior(enable: true, builder: (dynamic data, dynamic point, dynamic series, int pointIndex, int seriesIndex) {
                  return Container(height: 50,
                    ...
                    child: Text('${data.dateTime.year}.${data.dateTime.month}. - ${data.totalPrice.toStringAsFixed(2)} ${data.currency}'),);
                }),
                  ...
                  FastLineSeries<_TotalPriceData, DateTime>(
                    dataSource: List.generate(
                        ...
                        (index) => _TotalPriceData(
                            ...
                            timeSeriesData.y[index].toDouble(), timeSeriesData.yUnit)),
